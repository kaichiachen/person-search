...
from naf.network import Network
from naf.statistic import Statistic
from naf.exploration import OUExploration, BrownianExploration, LinearDecayExploration
from naf.utils import get_model_dir, preprocess_conf
from env import Env
...
def main(_):
  ...
  with tf.Session() as sess:
    # environment
    env = Env()#gym.make(conf.env_name)
