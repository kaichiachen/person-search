...
N_WORKERS = 2#multiprocessing.cpu_count() # number of workers
...
class Worker(object):
    def __init__(self, name, globalAC, sess):
        #self.env = Env()   # make environment for each worker
        self.name = name
    ...
    def work(self):
        ...
        while not coord.should_stop() and global_episodes < MAX_GLOBAL_EP:
            ...
            for ep_t in range(MAX_EP_STEP):
                ...
                s_, r, done = env.step(a, ep_t == (MAX_EP_STEP-1)) # make step in environment
